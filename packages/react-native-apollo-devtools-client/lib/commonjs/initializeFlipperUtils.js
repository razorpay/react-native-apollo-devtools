...
exports.initializeFlipperUtils = void 0;

var _utilities = require("@apollo/client/utilities");

var _flipperUtils = require("./flipperUtils");
...
function getAllQueries(client) {
  ...
  const allQueries = (0, _flipperUtils.getQueries)(queryMap);
  return allQueries === null || allQueries === void 0 ? void 0 : allQueries.map(_flipperUtils.getQueryData);
}
...
function getMutationData(allMutations) {
  ...
  return (_ref = [...Object.keys(allMutations)]) === null || _ref === void 0 ? void 0 : _ref.map(key => {
    ...
    return {
      id: key,
      name: (0, _utilities.getOperationName)(mutation),
      variables,
      loading,
      error,
...
const initializeFlipperUtils = (flipperConnection, apolloClient) => {
...
exports.initializeFlipperUtils = initializeFlipperUtils;
